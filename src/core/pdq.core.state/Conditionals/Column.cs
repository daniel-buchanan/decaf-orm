...
namespace pdq.core.state.Conditionals
{
	public class Column : Where
	{
        ...
        public static Column<T> ValueMatch<T>(state.Column column, EqualityOperator op, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, op, valueFunction, value);

        public static Column<T> Equals<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, EqualityOperator.Equals, valueFunction, value);

        public static Column<T> NotEquals<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, EqualityOperator.NotEquals, valueFunction, value);

        public static Column<T> LessThan<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, EqualityOperator.LessThan, valueFunction, value);

        public static Column<T> LessThanOrEqualTo<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, EqualityOperator.LessThanOrEqualTo, valueFunction, value);

        public static Column<T> GreaterThan<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
			=> new Column<T>(column, EqualityOperator.GreaterThan, valueFunction, value);

        public static Column<T> GreaterThanOrEqualTo<T>(state.Column column, T value, ValueFunctions.ValueFunction<T> valueFunction = null)
