...
namespace pdq
{
    ...
    public interface IGroupByTyped<T1, T2> : IExecute, IGroupByTyped<T1>
    {
        IGroupByThenTyped<T1, T2> GroupBy(Expression<Func<T1, T2, object>> builder);
    }

    public interface IGroupByTyped<T1, T2, T3> : IExecute, IGroupByTyped<T1, T2>
    {
        IGroupByThenTyped<T1, T2, T3> GroupBy(Expression<Func<T1, T2, T3, object>> builder);
    }

    public interface IGroupByTyped<T1, T2, T3, T4> : IExecute, IGroupByTyped<T1, T2, T3>
    {
        IGroupByThenTyped<T1, T2, T3, T4> GroupBy(Expression<Func<T1, T2, T3, T4, object>> builder);
    }

    public interface IGroupByTyped<T1, T2, T3, T4, T5> : IExecute, IGroupByTyped<T1, T2, T3, T4>
    {
    ...
    public interface IGroupByThenTyped<T1, T2, T3, T4, T5> : IOrderByTyped<T1, T2, T3>, IExecute
    {
        IGroupByThenTyped<T1, T2, T3, T4, T5> ThenBy(Expression<Func<T1, object>> builder);
        IGroupByThenTyped<T1, T2, T3, T4, T5> ThenBy(Expression<Func<T1, T2, object>> builder);
        IGroupByThenTyped<T1, T2, T3, T4, T5> ThenBy(Expression<Func<T1, T2, T3, object>> builder);
        IGroupByThenTyped<T1, T2, T3, T4, T5> ThenBy(Expression<Func<T1, T2, T3, T4, object>> builder);
