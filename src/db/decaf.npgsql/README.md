# decaf-orm.npgsql
This package is the Npgsql implementation for [decaf-orm](https://www.nuget.org/packages/decaf-orm/), it provides all the method implementations to build queries specifically for PostgreSQL databases.
